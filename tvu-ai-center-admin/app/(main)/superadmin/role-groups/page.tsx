    ...
    const renderHeader1 = () => {
        return (
            <div className="flex justify-content-between">
                <Button type="button" icon="pi pi-plus" label="Thêm quyền mới" outlined onClick={() => router.push('/superadmin/role-groups/create')} />
            </div>
        );
    };
    ...
    const actionBody = (rowData: any) => {
        return (
            <div className="flex justify-content-center gap-2">
                <Button icon="pi pi-pencil" className="p-button-rounded p-button-success p-mr-2" onClick={() => router.push(`/superadmin/role-groups/${rowData.id}`)} />
