namespace AICenterAPI.Models
{
    public class EducationModel
    {
        ...
        public EducationContentModel Content { get; set; } = new EducationContentModel();
    ...
    public class EducationDetailUpdateModel
    {
        public List<EducationContentModel> Contents { get; set; } = new List<EducationContentModel>();
    ...
    public class CreateEducationModel
    {
        ...
        public string? EducationContents { get; set; } = null;
